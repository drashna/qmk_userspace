  ...
  LAYOUT_5x6_full_right_wrapper( \
     ...
     KC_GRV, DISPLAY_MENU, OS_LGUI, OS_LALT,                                            OS_RALT, OS_RGUI, DISPLAY_MENU, KC_ESC, \
                                KC_MUTE, KC_GRV,                                        MS_BTN3,  \
                                         ...
                                         BK_LWER, TT(_MOUSE),      TG(_MOUSE), DL_RAIS  \
  )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_5x6_full_right_wrapper(
        _______, _______, _______, _______, _______, _______,                        XXXXXXX, DPI_RMOD,DPI_MOD, S_D_RMOD,S_D_MOD, MS_JGTG,
        _______, ___________________BLANK___________________,                        _________________MOUSE_R1__________________, MS_JGPN,
        _______, ___________________BLANK___________________,                        _________________MOUSE_R2__________________, MS_JGPP,
