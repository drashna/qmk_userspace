 ...
 *
 * \param string The string to type out.
 * \param interval The amount of time, in milliseconds, to wait before typing the next character. Note this can be set
 * to 0 to ensure no delay, regardless of what TAP_CODE_DELAY is set to.
 */
 ...
 *
 * \param ascii_code The character to type.
 * \param interval The amount of time, in milliseconds, to wait in between key presses. Note this can be set to 0 to
 * ensure no delay, regardless of what TAP_CODE_DELAY is set to.
 */
