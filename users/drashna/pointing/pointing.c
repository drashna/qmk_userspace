...
static const uint8_t pmw33xx_firmware_signature[3] = {0x42, 0xBD, 0x04};

// Firmware Blob for PMW3360
// clang-format off
static const uint8_t pmw33xx_firmware_data[4094]  = {
...
uint8_t pmw33xx_srom_get_byte(uint16_t position) {
    return pmw33xx_firmware_data[position];
}
...
bool pmw33xx_check_signature(uint8_t sensor) {
    ...
    return memcmp(signature_dump, pmw33xx_firmware_signature, sizeof(signature_dump)) == 0;
}
#endif // DRV_PMW33XX_ENABLE_FIRMWARE
