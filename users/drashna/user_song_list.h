...
/* Notes for audio song generation
 *
 * This can be used for song generation https://onlinesequencer.net/
 * The 8 Bit Square instrument is the best option here, as this most closely
 * resembles the sound generated by QMK's audio engine.
 *
 * Once you have your song, you can test it here:
